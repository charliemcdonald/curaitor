...
export function Result() {
  return (
    <div id="testResultSummary" className="bg-black md:w-1/2 w-full text-white flex flex-col justify-center items-center m-0 md:rounded-r-[2em] max-md:rounded-b-[2em]">
